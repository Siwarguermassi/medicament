...
stage1.close();
    ...
    private void pdf(ActionEvent event) {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\user\\Desktop\\fiche.pdf"));
            document.open();
       
            Paragraph ph1 = new Paragraph("Bienvenue à notre application !", redFont);
    ...
    private void quantite(ActionEvent event) throws IOException {
         ...
         Parent root = FXMLLoader.load(getClass().getResource("/pipharmacie/GUI/Back/Fiche/quantite.fxml"));
     Stage stage1 = (Stage) quantites.getScene().getWindow();
stage1.close();
        Scene scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
