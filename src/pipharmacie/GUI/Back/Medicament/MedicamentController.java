...
medicamentService md=new medicamentService();
 ...
 Stage stage = new Stage();
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/pipharmacie/GUI/Back/Medicament/ajoutMedicament.fxml"));
...
stage1.close();
    ...
    private void ajoutfiche(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/pipharmacie/GUI/Back/Fiche/fiche.fxml"));
         Stage stage1 = (Stage) ajoutfiche.getScene().getWindow();
stage1.close();
        Scene scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
...
@FXML
    private void stat(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/pipharmacie/GUI/Back/Medicament/statistique.fxml"));
    ...
    private void ajoutcategorie(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/pipharmacie/GUI/Back/Medicament/categorie.fxml"));
         Stage stage1 = (Stage) ajoutcategorie.getScene().getWindow();
stage1.close();
        Scene scene = new Scene(root);
        stage.setScene(scene);
        stage.show(); 
